...
class DepartementController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $departements = $em->getRepository('GestionBudgetBundle:Departement')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('GestionBudgetBundle\Form\DepartementType', $departement);
    ...
    {
        $deleteForm = $this->createDeleteForm($departement);
        $editForm = $this->createForm('GestionBudgetBundle\Form\DepartementType', $departement);
