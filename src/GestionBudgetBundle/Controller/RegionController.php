...
use GestionBudgetBundle\Entity\Region;
...
class RegionController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $regions = $em->getRepository('GestionBudgetBundle:Region')->findAll();
    ...
    {
        $region = new Region();
        $form = $this->createForm('GestionBudgetBundle\Form\RegionType', $region);
    ...
    {
        $deleteForm = $this->createDeleteForm($region);
        $editForm = $this->createForm('GestionBudgetBundle\Form\RegionType', $region);
